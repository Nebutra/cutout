...
description: Compile and export an approved Next App Router or Vite React starter from verified Design IR, components, tokens, routes, and assets. Use for a runnable starter repository.
---
...
- Only Next App Router and Vite React

---
name: brand-vi-kit
description: Plan and export an evidence-backed Brand Visual Identity Kit. Use for logo, color, typography, auxiliary graphics, applications, mascot direction, or an A1-A5 and B1-B13 VI program.
---
...
Status: `available`.
Operations: `export.brand-kit`.
MCP tools: `cutout_plan_brand_kit_export`, `cutout_export_brand_kit`.
...
- Core export is not every VI plate
- Visual plates require governed generation
- No trademark-clearance claims

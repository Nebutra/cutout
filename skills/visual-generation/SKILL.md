...
description: Plan governed multimodal generation, editing, cutout, variants, and selection as an approval-aware visual DAG. Use for generated imagery, VI plates, campaign assets, mockups, or visual exploration.
---
...
- Bundled headless host has no provider
- No generation MCP tool is advertised
- Prompts are not delivered assets

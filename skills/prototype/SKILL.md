---
name: prototype
description: Create and validate a reachable outcome-oriented prototype plan. Use when defining pages, flows, interactions, states, overlays, and visual deliverables.
---
...
- No public operation authors prototype plans
- Validation does not generate images
- Every page must be explicitly reachable

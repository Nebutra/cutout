...
description: Turn explicit verified component candidates into contracts and implementation delivery plans. Use for reusable components, variants, slots, states, and token bindings.
---
...
- Verified prototype or code references
...
- No screenshot-to-JSX guessing
- No public component export operation
- Complex work requires coding delivery

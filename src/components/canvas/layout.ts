...
import { BOARD_NODE_ID, SLICES_NODE_ID } from '@/store/slices/pipeline'
...
/** The forward order of the P1 chain; a node's index drives its x. */
const CHAIN_ORDER: readonly string[] = [BOARD_NODE_ID, SLICES_NODE_ID]

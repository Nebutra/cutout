...
const document: DesignDocument = {
  ...
  prototype: { id: 'prototype:1', plan: { version: 'prototype-plan.v0', product: { name: 'Product', summary: 'Summary', audience: 'Users', primaryGoal: 'Ship', platform: 'web' }, designSystem: { styleSummary: 'Quiet', palette: ['#fff'], typography: 'Sans', spacing: '4px', componentPrinciples: ['Clear'], assetDirection: 'Approved only', exploration: currentPrototypeExploration }, pages: [{ id: 'page:home', name: 'Home', route: '/', purpose: 'Home', viewport: { platform: 'web', width: 1440, height: 900, scroll: 'single-screen' }, regions: [{ id: 'region:hero', name: 'Hero', role: 'hero', summary: 'Hero region', complexity: 'low', assetRoute: 'ignore-code-ui', decompositionStrategy: 'direct', assetOpportunities: [] }], overlays: [], states: [], interactions: [] }], flows: [{ id: 'flow', name: 'Flow', goal: 'Ship', startPageId: 'page:home', steps: [] }], reviewDocument: currentPrototypeReviewDocument, humanLoop: { mode: 'continue', rationale: 'Explicit selection' } } },
  materials: [{ id: 'material:screen', kind: 'image', name: 'Screen', currentRevisionId: 'material-revision:1', revisions: [{ id: 'material-revision:1', ordinal: 1, createdAt: at, content: { id: 'content:screen', uri: `sha256:${'a'.repeat(64)}`, sha256: 'a'.repeat(64), mediaType: 'image/png' } }] }], candidateSets: [], provenance: [],

...
export function createPrototypePageVisualTask(input: { readonly runId: string; readonly plan: PrototypePlan; readonly page: PrototypePage; readonly image: ModelAssignment; readonly prompt: string; readonly referenceArtifactIds: readonly string[] }): VisualGenerationTask {

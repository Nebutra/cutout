...
describe('ui-prototype-planner v1.6.0', () => {
  ...
  it('is discoverable through the built-in registry as latest', () => {
    ...
    expect(registry.resolve('ui-prototype-planner').version).toBe('1.6.0')

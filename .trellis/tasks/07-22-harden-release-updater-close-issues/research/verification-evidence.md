...
- Full Vitest: 335 files passed, 6 skipped; 1642 tests passed, 15 skipped.
- Rust: 104 library tests and 3 updater-signature binary tests passed.
- Release-critical Playwright: 2 tests passed on `desktop-chrome`.
...
- Lingui extraction removed the two obsolete remembered-export-directory
  messages from all five locale catalogs. The clean-commit CI run must confirm
  extraction produces no further diff.

...
Download the Apple Silicon DMG from [Cutout v0.1.17](https://github.com/Nebutra/cutout/releases/tag/v0.1.17), then drag Cutout into Applications.
...
```bash
codex plugin marketplace add Nebutra/cutout --ref v0.1.17
...
```text
cutout@cutout-local  installed, enabled  0.1.17
```
